...
func NewSystemInfo(startTime time.Time) *SystemInfo {
	...
	return &SystemInfo{
		...
		HeapInuse:    zfile.SizeFormat(int64(mstat.HeapInuse)),
		UsedMem:      zfile.SizeFormat(int64(mstat.Alloc)),
		TotalMem:     zfile.SizeFormat(int64(mstat.TotalAlloc)),
		SysMem:       zfile.SizeFormat(int64(mstat.Sys)),
		...
		NextGC:       zfile.SizeFormat(int64(mstat.NextGC)),
